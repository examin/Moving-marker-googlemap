...
public class MovingMarkerActivity extends AppCompatActivity implements OnMapReadyCallback, RoutingListener, GoogleApiClient.OnConnectionFailedListener, GoogleApiClient.ConnectionCallbacks {
    ...
    LatLng startpoint= new LatLng(28.4595,77.0266);  //gurganv
    //LatLng startpoint=new LatLng(28.4593,77.0724); //hooda city  center
    LatLng endpont=new LatLng(27.4924,77.6737);   //mathura
    //LatLng endpont=new LatLng(28.4634,77.0768);   // sushnat lok
    protected LatLng start=startpoint;
    protected LatLng end=endpont;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("App2mobile driver tracker ");
    ...
    public class Animator implements Runnable {
        ...
        private static final int ANIMATE_SPEEED = 150;
    ...
    public void route() {
        if (start == null || end == null) {
            ...
            //CameraUpdate center = CameraUpdateFactory.newLatLng(new LatLng(mLatitude, mLongitude));  //ts
